...
public class DBService {
    ...
    public void initDB(){
        ...
        ContaBancaria contaBancaria3 = new ContaBancaria(null,"Cartão de Credito","A","0678","53374-3",new BigDecimal("32000.00"), TipoConta.CARTAOCREDITO,usuario1,banco1);
        ContaBancaria contaBancaria4 = new ContaBancaria(null,"Conta Alimentação","A","0678","53374-4",new BigDecimal("32000.00"), TipoConta.ALIMENTACAO,usuario1,banco1);
        ContaBancaria contaBancaria5 = new ContaBancaria(null,"Conta Poupança","A","0678","53374-5",new BigDecimal("32000.00"), TipoConta.CONTAPOUPANCA,usuario1,banco1);
        ...
        //  Lancamento
        Lancamento lancamento1 = new Lancamento(null,"Compra de roupas",LocalDate.now(),LocalDate.now(),LocalDate.now(),new BigDecimal("320.00"), TipoLancamento.CREDITO, Situacao.ABERTO,usuario1,categoria1,contaBancaria1);
        Lancamento lancamento2 = new Lancamento(null,"Conta de agua",LocalDate.now(),LocalDate.now(),LocalDate.now(),new BigDecimal("320.00"), TipoLancamento.DEBITO, Situacao.BAIXADO,usuario1,categoria1,contaBancaria1);
        Lancamento lancamento3 = new Lancamento(null,"Compras do mes",LocalDate.now(),LocalDate.now(),LocalDate.now(),new BigDecimal("320.00"), TipoLancamento.CREDITO, Situacao.ATRASADO,usuario1,categoria1,contaBancaria1);
